...
import 'package:dujo_kerala_application/view/pages/chat/teacher_section/student_message/chats/students_chats.dart';
            ...
            itemBuilder: (context, index) {
              ...
              return GestureDetector(
                onTap: () {
                  ...
                  Get.to(StudentsChatsScreen(studentDocID: data.docid!, studentName: data.studentName!));
                },
                child: Container(
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(10),
