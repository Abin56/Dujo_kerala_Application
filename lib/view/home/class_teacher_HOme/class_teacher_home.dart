...
import '../../../controllers/class_Teacher_FirebaseData_Controller/getx.dart';
import '../../../sruthi/User Edit Profile/user_edit_profile.dart';

class ClassTeacherHomeScreen extends StatelessWidget {
  GetFireBaseData gextController = Get.put(GetFireBaseData());

  Widget build(BuildContext context) {
    var screenSize = MediaQuery.of(context).size;
    return Obx(() {
      gextController.fetchAllTeacherData();

      if (gextController.classIncharge.isEmpty &&
          gextController.teacherName.isEmpty &&
          gextController.employeeID.isEmpty &&
          gextController.classIncharge.isEmpty &&
          gextController.teacherEmail.isEmpty &&
          gextController.teacherImage.isEmpty) {
        return const Center(
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: GoogleMonstserratWidgets(
                                ...
                                text: gextController.teacherName.value,
                                fontsize: 23.sp,
                                ...
                                GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: Color.fromARGB(120, 4, 97, 174),
                                        shape: BoxShape.circle,
                                        image: DecorationImage(
                                          fit: BoxFit.fill,

                                            image: NetworkImage(gextController
                                                .teacherImage.value))),
                                  ),
                                ),
                                Positioned(
                      ...
                      GoogleMonstserratWidgets(
                        text: 'ID : ${gextController.employeeID.value}',
                        fontsize: 14.5.sp,
                        fontWeight: FontWeight.w500,
                        color: cWhite.withOpacity(0.8),
                      ),
                      GoogleMonstserratWidgets(
                        text: 'email : ${gextController.teacherEmail.value}',
                        fontsize: 12.sp,
                        fontWeight: FontWeight.w500,
