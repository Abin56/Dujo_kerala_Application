...
class ResetPassword extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    iconTheme: const IconThemeData(color: Colors.black,size: 30,weight: 500)),

      body: SafeArea(child: SingleChildScrollView(
        child: Column(children: [
      
          ContainerImage(height: 400.h
          , width: double.infinity, imagePath: 'assets/images/lock reset.png'),
              ...
              child:
               Padding(
                 ...
                 child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                   children: [
                     GooglePoppinsWidgets(text: 'Reset', fontsize: 25,fontWeight: FontWeight.w700),
                     GooglePoppinsWidgets(text: 'Password', fontsize: 23,fontWeight: FontWeight.w700),
                     kHeight20,
                     Form(key: formKey,
                          child:  Column(
                            children: [
                              Obx(() => SigninTextFormfield(
