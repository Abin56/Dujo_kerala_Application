    ...
    child: Column(
      ...
      children: [
       ...
       Padding(
        ...
        kWidth10,
        GoogleMonstserratWidgets(text: 'Ajay', fontsize: 18,color: cWhite,fontWeight: FontWeight.bold),
        kWidth10,
        GoogleMonstserratWidgets(text: 'ajay@email.com', fontsize: 18,color: cWhite,fontWeight: FontWeight.bold),
          ]),
        ),
