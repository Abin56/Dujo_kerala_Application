...
class SchoolLevelNoticePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      itemCount: studentNoticeController.noticeLists.length,
        ...
        return Container(
          ...
          child: ListTile(
            ...
            title: GooglePoppinsWidgets(
              fontsize: 22.h,
              text: studentNoticeController.noticeLists[index].heading,
            ),
            subtitle: GooglePoppinsWidgets(
              fontsize: 14.h,
              text: studentNoticeController.noticeLists[index].publishedDate,
            ),
            trailing: InkWell(
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => NoticeClassDisplayPage(
                          noticeModel:
                              studentNoticeController.noticeLists[index]),
                    ));
              },
            ),
          ),
